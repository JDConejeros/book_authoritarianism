...
#Chile
chile_isl <-  as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLCHLC2.sav"))
chile_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGCHLC2.sav"))
chile     <- merge(chile_isl, chile_isg, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))
#México
mexico_isl <-  as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLMEXC2.sav"))
mexico_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGMEXC2.sav")) 
mexico     <- merge(mexico_isl, mexico_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Colombia
colombia_isl <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLCOLC2.sav"))
colombia_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGCOLC2.sav"))
colombia     <- merge(colombia_isl, colombia_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Paraguay
paraguay_isl <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLPRYC2.sav"))
paraguay_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGPRYC2.sav"))
paraguay     <- merge(paraguay_isl, paraguay_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Guatemala
guatemala_isl <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLGTMC2.sav"))
guatemala_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGGTMC2.sav"))
guatemala     <- merge(guatemala_isl, guatemala_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#República Dominicana
dominican_rep_isl <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISLDOMC2.sav"))
dominican_rep_isg <- as.data.frame(read_spss("ICCS2009_IDB_SPSS/Data_G8/ISGDOMC2.sav"))
dominican_rep     <- merge(dominican_rep_isl, dominican_rep_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Append: all obervations preserve
iccs09 <- rbind(chile, mexico, colombia, paraguay, guatemala, dominican_rep)
#class(iccs09)
#dim(iccs09)
#head(iccs09)
#str(iccs09)
...
#ICCS 2016: Latinamerica module, student questionnaire, teachers, school
#Chile
chile_isl <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISLCHLC3.sav"))
chile_isg <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISGCHLC3.sav"))
chile     <- merge(chile_isl, chile_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#México
mexico_isl <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISLMEXC3.sav"))
mexico_isg <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISGMEXC3.sav")) 
mexico     <- merge(mexico_isl, mexico_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Colombia
colombia_isl <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISLCOLC3.sav"))
colombia_isg <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISGCOLC3.sav"))
colombia     <- merge(colombia_isl, colombia_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Perú
peru_isl <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISLPERC3.sav"))
peru_isg <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISGPERC3.sav"))
peru     <- merge(peru_isl, peru_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#República Dominicana
dominican_rep_isl <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISLDOMC3.sav"))
dominican_rep_isg <- as.data.frame(read_spss("ICCS2016_IDB_SPSS/Data/ISGDOMC3.sav"))
dominican_rep     <- merge(dominican_rep_isl, dominican_rep_isg, by="IDSTUD", all=FALSE, suffixes = c("",".y"))
#Append: all obervations preserve
iccs16 <- rbind(chile, mexico, colombia, peru, dominican_rep)
#class(iccs16)
#dim(iccs16)
#head(iccs16)
#str(iccs116)
...
rm(list = ls()) 
#Load Data
load("BBDD_ICCS/ICCS09.Rdata")
load("BBDD_ICCS/ICCS16.Rdata")
#skim(iccs09)
#skim(iccs16)
```
