...
# Latin American 2009-2016: Institutional, Support Authoritarianism and Civic Knowledge
...
#All graphs
library(ggpubr)
png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g1.png", height = 300)
ggarrange(dicta, ncol = 1, nrow = 1,  common.legend = TRUE, legend="right")
dev.off()

png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g2.png", height = 430)
...
#All graphs
png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g3.png", height = 300)
ggarrange(trust, ncol = 1, nrow = 1,  common.legend = TRUE, legend="right")
dev.off()

png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g4.png", height = 430)
ggarrange(nac, local, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g5.png", height = 430)
ggarrange(parliament, parties, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g6.png", height = 430)
ggarrange(courts, police, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "~/Dropbox/book_authoritarianism/Resultados/graph/g7.png", height = 300)
