...
#Chile
chi09 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/islchlc2.sas7bdat"))
chi092 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isgchlc2.sas7bdat")) 
chi     <- merge(chi09, chi092, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Mexico
mex09 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/islmexc2.sas7bdat"))
mex092 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isgmexc2.sas7bdat"))
mex   <- merge(mex09, mex092, by="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Colombia
col09 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/islcolc2.sas7bdat"))
col092 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isgcolc2.sas7bdat"))
col   <- merge(col09, col092, by="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Paraguay
pry09 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/islpryc2.sas7bdat"))
pry092 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isgpryc2.sas7bdat"))
pry   <- merge(pry09, pry092, by="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Guatemala
gtm09 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/islgtmc2.sas7bdat"))
gtm092 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isggtmc2.sas7bdat"))
gtm   <- merge(gtm09, gtm092, by="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Domincan Republic
dom09 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isldomc2.sas7bdat"))
dom092 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2009/isgdomc2.sas7bdat"))
...
#ICCS 2009
save(iccs09, file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Analisis/ICCS09.Rdata")
...
#Chile
chi16 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/islchlc3.sas7bdat"))
chi162 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isgchlc3.sas7bdat"))
chi     <- merge(chi16, chi162, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#México
mex16 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/islmexc3.sas7bdat"))
mex162 <-  as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isgmexc3.sas7bdat"))
mex     <- merge(mex16, mex162, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Colombia
col16 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/islcolc3.sas7bdat"))
col162 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isgcolc3.sas7bdat"))
col     <- merge(col16, col162, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#República Dominicana
dom16 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isldomc3.sas7bdat"))
dom162 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isgdomc3.sas7bdat"))
dom     <- merge(dom16, dom162, by ="IDSTUD", all=FALSE, suffixes = c("",".y"))#Merge
#Perú
per16 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/islperc3.sas7bdat"))
per162 <- as.data.frame(read_sas("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Original/2016/isgperc3.sas7bdat"))
...
#ICCS 2016
save(iccs16, file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Analisis/ICCS16.Rdata")
```
...
load("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Analisis/ICCS09.Rdata")
load("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Data/Analisis/ICCS16.Rdata")
```
...
png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g2.png", height = 430)
...
#All graphs
png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g3.png", height = 300)
ggarrange(trust, ncol = 1, nrow = 1,  common.legend = TRUE, legend="right")
dev.off()

png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g3b.png", height = 300)
ggarrange(trust2, ncol = 1, nrow = 1,  common.legend = TRUE, legend="right")
dev.off()

png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g4.png", height = 430)
ggarrange(nac, local, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g5.png", height = 430)
ggarrange(parliament, parties, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g6.png", height = 430)
ggarrange(courts, police, ncol = 1, nrow = 2,  common.legend = TRUE, legend="right")
dev.off()

png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g7.png", height = 300)
...
#Plot
library(sjPlot)
png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g8.png", height = 300)
dev.off()
...
#Plot
library(sjPlot)
png(file = "C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g8b.png", height = 300)
dev.off()
